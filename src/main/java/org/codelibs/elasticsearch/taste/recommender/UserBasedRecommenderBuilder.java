...
import org.codelibs.elasticsearch.taste.recommender.svd.ALSWRFactorizer;
import org.codelibs.elasticsearch.taste.recommender.svd.SVDRecommender;
...
public class UserBasedRecommenderBuilder extends AbstractRecommenderBuilder {
	...
	public Recommender buildRecommender(final DataModel dataModel) {
		...
		ALSWRFactorizer factorizer = new ALSWRFactorizer(dataModel, 2, 0.07, 2);
