...
public abstract class ActionRestHandler {
    ...
    public ActionRestHandler(final Settings riverSettings, final Client client) {
        this.client = client;
        logger = Loggers.getLogger(getClass(), riverSettings);
        rootSettings = riverSettings.getAsStructuredMap();
    }
