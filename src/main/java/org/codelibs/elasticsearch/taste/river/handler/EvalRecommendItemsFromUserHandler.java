...
public class EvalRecommendItemsFromUserHandler extends RecommendationHandler {
    private RMSRecommenderEvaluator evaluator;

    public EvalRecommendItemsFromUserHandler(final RiverSettings settings,
    ...
    protected void evaluate(final DataModel dataModel,
            ...
            final RMSRecommenderEvaluator evaluator, final ObjectWriter writer,
        ...
        try {
            ...
            evaluationObj.put("stdDeviation", evaluation.getStdDeviation());
    ...
    protected RMSRecommenderEvaluator createEvaluator(
        ...
        try {
            ...
            final RMSRecommenderEvaluator evaluator = recommenderEvaluatorFactory.create();
